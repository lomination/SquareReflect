public class FragileAngle : Tile {
    ...
    public override string ToString() {
        return dir switch {
            ...
            Status.IsGoingDown => "◥",
            Status.IsGoingLeft => "◢",
            _ => throw new Exception($"\"FragileAngle\" private field \"dir\" does not contain a direction and cannot be shown. Current value : {dir}, expected : GoingUp, GoingRight, GoingDOwn, or GoingLeft"),
        };
    }
